...
const UserPageCoverSection = () => {
  return (
    <div className="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl coverSection">
      <div className="card-body p-0 rounded-xxl overflow-hidden m-3 coverWrapper">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPY2VZ4bAKPMe8dLhcsPgnp4JA70NmAcUgK8_rVXlH&s"
          alt="avater"
      ...
      <div className="card-body p-0 position-relative">
        <figure
          className="avatar position-absolute w100 z-index-1 avatar"
        ...
        <h4 className="fw-700 font-sm mt-2 mb-lg-5 mb-4 pl-15 font">
          Mohannad Zitoun{" "}
      ...
      <div className="card-body d-block w-100 shadow-none mb-0 p-0 border-top-xs userTabs">
        <ul
...
export default UserPageCoverSection;
